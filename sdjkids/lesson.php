...
<div id="agreement-lesson" class="agreement modal fade" tabindex="-1" role="dialog">
...
<script>
    var lessonModal = new Modal({
        el: document.getElementById('agreement-lesson')
    });

    var dialog = $('#agreement-lesson .modal-dialog');

    $('.tutorial__button-lesson').click(function() {
        lessonModal.show();
        var mTop = (window.innerHeight - dialog.height()) / 2;
        dialog.css('margin-top', mTop + 'px');

        var form = $('#agreement-lesson .form');
        form.css('margin-top', ($('#agreement-lesson .modal-tab-2').height() - form.height()) / 2 + 'px');
    });

    $('#agreement-lesson .close').click(function () {
        lessonModal.hide();
    });

    $('#agreement-lesson .form-group').change(function() {
        $(this).isValid();
    });

    $('#agreement-lesson .agreement__send').click(function (e) {
        e.preventDefault();
        var form = $('#agreement-lesson .form');
