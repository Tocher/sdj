    ...
    <div class="top__container">
        <div class="upper">
            ...
            <div class="top__subtitle">
                Для тех, кто хочет изучить и на практике освоить игру<br>
                на самом современном диджейском оборудовании ( от 7 лет )
            </div>
        </div>
        <div class="kurs">
            <div style="width:60vw;padding-right:4vw;">
                <img src="img/kurs_page_bg.jpg" style="max-width: 100%;">
            </div>
            <div class="program__text" style="width:40vw;">
                <div class="program__text-title">Наши преимущества:</div>

                <div>
                    - Курс состоит из теории и практики диджейского<br>
                    мастерства и дает базовые навыки для дальнейшего<br>
                    развития
                </div>
                <div>
                    - 15 часов живого обучения, состоящего в основном из<br>
                ...
                <span>Обучение в группе:</span>
                10 тренингов по 120 минут - 200 рублей<br>
                <span>Индивидуальное обучение:</span>
                10 тренингов по 90 минут - 600 рублей<br>
                <span>За курс студент записывает свой микс<br>
